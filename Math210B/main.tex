...
\input{CH2/1 Euclidean Domains.tex}
\newpage

\section{Number Theory in a Ring}
\input{CH2/2 Number Theory in a Ring.tex}
\newpage

\section{Principal Ideal Domains}
\input{CH2/3 Principal Ideal Domains.tex}
\newpage

\section{Unique Factorization Domains}
\input{CH2/4 Unique Factorization Domains.tex}
\newpage

\chapter{Polynomials and Vector Spaces}
\section{Polynomials Over a Field}
\input{CH3/1 Polynomials Over a Field.tex}
\newpage

\section{Irreducibility Criterion}
\input{CH3/2 Irreducibility Criterion.tex}
\newpage

\section{Vector Spaces}
\input{CH3/3 Vector Spaces.tex}
\newpage

\chapter{Field Theory}
\section{Extension Fields}
\input{CH4/1 Extension Fields.tex}
\newpage

\section{Simple Extensions}
\input{CH4/2 Simple Extensions.tex}
\newpage

\section{Algebraic Extensions}
\input{CH4/3 Algebraic Extensions.tex}
\newpage

\section{Splitting Fields and Algebraic Closure}
\input{CH4/4 Splitting Fields and Algebraic Closure.tex}
\newpage

\section{Splitting Fields of Cyclotomic Fields}
\input{CH4/5 Splitting Fields of Cyclotomic Fields.tex}
\newpage

\section{Derivative of a Polynomial}
\input{CH4/6 Derivative of a Polynomial.tex}
\newpage

\chapter{Galois Theory}
\section{Field Automorphisms and Galois Groups}
\input{CH5/1 Field Automorphisms and Galois Groups.tex}
\newpage
